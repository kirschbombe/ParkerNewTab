...
var UI = React.createClass({
  ...
  manifestUrl() {
    return "https://dms-data.stanford.edu/data/manifests/Parker/" + this.state.mapid + '/manifest.json';
  },

  purlUrl() {
    return 'https://parker.stanford.edu/parker/catalog/' + this.state.mapid;
  },
